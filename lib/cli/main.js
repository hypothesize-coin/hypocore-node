...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `hypocore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ hypocore-node add wallet-service');
      console.log('    $ hypocore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ hypocore-node remove wallet-service');
      console.log('    $ hypocore-node remove insight-api');
      console.log();
    });
