...
/**
 * Will return the path and default hypocore-node configuration. It will search for the
 * configuration file in the "~/.hypothesize" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.hypothesize');
  var defaultConfigFile = path.resolve(defaultPath, './hypocore-node.json');
